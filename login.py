...
class App(tk.Tk):
    ...
    def create_menu_button(self):
        ...
        norm_button.configure("control.TMenubutton", font="consolas 12 bold", background="#000000", relief="flat", foreground="#FFFFFF")
        norm_button.map('control.TMenubutton', background=[('active', '#262626')])
        ...
        menu_button = ttk.Menubutton(
            self,
            text='sin', style='control.TMenubutton')
